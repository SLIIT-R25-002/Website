...
const AutonomousNavigation = ({ 
    ...
    const sendReferenceImage = async (imageObject) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/set_reference', {
                method: 'POST',
                body: formData,
            });
    ...
    const startVideoStream = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/start_stream', {
                method: 'POST',
                headers: {
    ...
    const stopVideoStream = async () => {
        try {
            const response = await fetch('http://localhost:5000/api/stop_stream', {
                method: 'POST'
            });
    ...
    const checkFrameMatches = useCallback(async () => {
        try {
            const response = await fetch('http://localhost:5000/api/next_frame');
            if (!response.ok) {
