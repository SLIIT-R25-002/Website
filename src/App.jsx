  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          name="description"
          content="HeatScape combines AI vision, mobile IoT sensing, and a lightweight digital twin to detect heat-driving surfaces and test mitigation strategies at street level."
        />
        ...
        <footer className="bg-gray-900 text-white py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-gray-400">
              © 2025 <span className="text-gray-300">Heat</span>
              <span className="text-primary-600">Scape</span>. All rights
              reserved.
            </p>
